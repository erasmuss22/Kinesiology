...
- (IBAction)insertURL:(UIBarButtonItem *)sender{
    UIAlertView *alert = [[UIAlertView alloc] initWithTitle:@"URL Address" message:@"Please enter XML file location:" delegate:self cancelButtonTitle:@"Cancel" otherButtonTitles:@"Okay", nil];
